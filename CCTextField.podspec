...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                        CCTextField 自定义TextField，解决输入限制、键盘弹出问题
                     DESC
  ...
  # Or just: s.author    = "cyd"
  # s.authors            = { "cyd" => "1035060416@qq.com" }
  # s.social_media_url   = "http://twitter.com/cyd"
  ...
  s.source = { :git => "https://github.com/cdcyd/CCTextField.git", :tag => "v1.2.1" }
